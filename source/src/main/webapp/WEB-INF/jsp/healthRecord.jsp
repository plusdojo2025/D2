		...
		<form method="POST" id="" action="HealthRecordServlet">
			<table class="">
				...
				<tr>
					<td><label>種類 <select name="exercise_type" id="">
						...
						<script>
							function updateMets() {
								...
								const metsInput = document.getElementById('mets');
					...
					<td><label>時間 <input type="text" name="exercise_time">分
					</label></td>
				...
				<tr>
					<td>飲酒量とアルコール度数</td>
					<td><label> 度数： <select name="alcohol_content">
								<option value="5">ビール</option>
								<option value="40">ウイスキー</option>
						</select> %
					</label></td>
					<td><label> 量： <select name="alcohol_consumed">
