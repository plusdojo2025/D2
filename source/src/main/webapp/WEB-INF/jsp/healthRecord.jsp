...
<body>
	...
	<div class="wrapper">
		...
		<form method="POST" id="form"
			...
			<label> 
				現在の体重[kg]：
				<input type="number" step="0.1" name="now_weight" value="60.0" min="0" required>
			</label>
			<br> 
			...
			<label> 
				睡眠時間[h]： 
				<input type="number" name="sleep_hours" step="0.5" default="7.0" value="7.0" min="0" required>
			</label> 
			...
			<label> 
			摂取カロリー[kcal]： 
			<input type="number" name="calorie_intake" min="0" step="100" value="2000" required> 
			</label> 
